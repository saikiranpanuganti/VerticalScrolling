...
protocol HomeCollectionViewFlowLayoutDelegate: AnyObject {
    func collectionView(_ collectionView: UICollectionView, heightForItemAtIndexPath indexPath: IndexPath) -> CGFloat
}


class HomeCollectionViewFlowLayout: UICollectionViewLayout {
    ...
    weak var delegate: HomeCollectionViewFlowLayoutDelegate?
    ...
    override func prepare() {
        ...
        for item in 0..<collectionView.numberOfItems(inSection: 0) {
            ...
            let photoHeight = delegate?.collectionView(collectionView, heightForItemAtIndexPath: indexPath) ?? 280
